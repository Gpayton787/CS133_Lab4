...
set Library     "hls"
set IPName      "kernel_cnn"
set Version     "1.0"
set DisplayName "Kernel_cnn"
set Revision    "2114094776"
...
set xo_kernel_name "kernel_cnn"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ubuntu/CS133_Lab4/cnn.prj/solution"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/ubuntu/CS133_Lab4/cnn.prj/solution/.debug"
set xo_hls_files_dir ""
set hdl_module_list {kernel_cnn_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "kernel_cnn_message_dict.json"

## Variables
set Top "kernel_cnn"
set TopNoPrefix "kernel_cnn"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_kernel_input m_axi_kernel_weight m_axi_kernel_output"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_kernel_input {
        ...
        data_width "128"
        port_prefix "m_axi_kernel_input"
        param_prefix "C_M_AXI_KERNEL_INPUT"
    ...
    m_axi_kernel_weight {
        ...
        data_width "32"
        port_prefix "m_axi_kernel_weight"
        param_prefix "C_M_AXI_KERNEL_WEIGHT"
    ...
    m_axi_kernel_output {
        ...
        data_width "512"
        port_prefix "m_axi_kernel_output"
        param_prefix "C_M_AXI_KERNEL_OUTPUT"
...
## System Info
set user_parameters_list {clk_period 4 machine 64 combinational 0 latency 159017426 II x}
